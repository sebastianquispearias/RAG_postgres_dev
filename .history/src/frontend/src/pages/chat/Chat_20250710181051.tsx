                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <SparkleFilled fontSize={"120px"} primaryFill={"rgb(68, 197, 36)"} aria-hidden="true" aria-label="Chat logo" />
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. muéstrame los abastecimientos con baja eficiencia?)"
                            disabled={isLoading}
